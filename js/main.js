...
function addClicks() {
  ...
  keys.forEach((key) => {
    key.addEventListener('mousedown', function mouseDown() {
      h.innerText = ''
    ...
    key.addEventListener('mouseup', function mouseUp(event) {
      event.preventDefault()
      if (key && key.classList[0] !== 'CapsLock' && 
          key.classList[0] !== 'ShiftRight' &&
          key.classList[0] !== 'ShiftLeft') {
    ...
    key.addEventListener('mouseout', function mouseOut(event) {
      event.preventDefault()
      if (key && key.classList[0] !== 'CapsLock' && 
        key.classList[0] !== 'ShiftRight' &&
        key.classList[0] !== 'ShiftLeft') {
